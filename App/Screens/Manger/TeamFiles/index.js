...
export default function TeamFiles(props) {
            ...
            <FlatList
              ...
              renderItem={({item}) => {
                return (
                  <AlbumCard
                    item={item}
                    navigation={() => props.navigation.navigate('uploadFiles')}
                    onView={()=>props.navigation.navigate('filesDetail',{albumId:item.albumId})}
                  />
                );
              }}
